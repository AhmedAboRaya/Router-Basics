...
const ErrorHandler = ({ statusCode = 500, title = "Server Error" }: IProps) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-5 w-full text-white">
      <div className="text-center">
        ...
        <div className="flex items-center justify-center space-x-4 my-10">
          <Link
            to={"/"}
            className="inline-block bg-white text-[#3e4566] rounded-xl border-2 border-white hover:bg-[#3e4566] hover:text-white duration-500 p-1 font-semibold"
            reloadDocument
          >
            Home
          </Link>
